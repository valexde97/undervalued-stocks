...
export default async function handler(req: any, res: any) {
  try {
    ...
    // stable route вместо legacy /api/v4/score
    const upstream = `https://financialmodelingprep.com/stable/financial-scores?symbol=${encodeURIComponent(
      symbol
